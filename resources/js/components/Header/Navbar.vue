...
<template>
    <header
        class="flex flex-wrap md:justify-start md:flex-nowrap z-50 bg-[#141414] px-2 sm:px-5 xl:px-0 dark:bg-[#141414]"
    >
        <div class="max-w-6xl flex flex-wrap lg:grid lg:grid-cols-3 basis-full items-center w-full mx-auto py-2.5">
            ...
            <div class="lg:order-2 basis-full grow lg:basis-auto lg:ms-5">
                ...
                >
                    ...
                    >
                        <div
                            class="flex flex-col lg:flex-row lg:justify-center lg:items-center lg:gap-y-0 lg:gap-x-3 pt-2 lg:pt-0"
                        >
                            <router-link
                            ...
                            <router-link
                                v-if="!user"
                                class="py-1.5 px-2 inline-flex items-center gap-x-2 text-sm font-medium rounded-md border border-transparent text-white hover:text-white/80 disabled:opacity-50 disabled:pointer-events-none focus:outline-none focus:bg-white/10 bg-white/10"
                                to="/login"
                            >
                                Login/Register
                            </router-link>
    ...
    <div
        class="py-3 flex items-center justify-center text-xs text-gray-400 uppercase w-full border-t border-gray-200 dark:text-neutral-500 dark:border-neutral-600"
    ></div>
</template>
